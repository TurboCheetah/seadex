...
const flex = (
    directionSmall: Direction = 'column',
    ...
    const addRelease = () => {
        ...
        fields.forEach((field: string) => {
            ...
            if (boolFields.includes(field)) {
                ...
                if (data === null) {
                    throw Error(
                        `${field} in release form data was unexpectedly null`
                    )
                }
    ...
    const handleNext = () => {
        if (formAltered) {
            const shouldContinue = confirm(
                'You have made changes to form but have not added the release. Are you sure you want to continue without saving changes?'
            )
            if (shouldContinue) {
    ...
    return (
        <>
            {releases.map((release, i) => (
                <Accordion
                    expanded={expanded === `${release.title}.${i}`}
                    key={`${release.title}.${i}`}
                    onChange={handleChange(`${release.title}.${i}`)}
                >
                    <AccordionSummary
            ...
            <Form ref={formRef} onChange={handleFormChange}>
                ...
                <TextField label="Notes" name="notes" fullWidth multiline />
                ...
                <TwoColumnGrid>
                    <FormGroup>
                        <FormControlLabel
                            control={<Checkbox name="dualAudio" />}
                            label="Dual Audio"
                        />
                    </FormGroup>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={
                                <Checkbox defaultChecked name="isRelease" />
                            }
                            label="Release"
                        />
                    </FormGroup>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={
                                <Checkbox defaultChecked name="isBestVideo" />
                            }
                            label="Best video"
                        />
                    </FormGroup>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={<Checkbox name="incomplete" />}
                            label="Incomplete"
                        />
                    </FormGroup>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={<Checkbox name="isExclusiveRelease" />}
